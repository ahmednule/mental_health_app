    ...
    const handleSubmit = async (e: { preventDefault: () => void }) => {
      ...
      try {
        ...
        if(data.status === 401 || data.status === 400 || data.status === 500){
          ...
          setLoading(false);
          toast.error(data.message  +  "  Or Ask your Administrator to approve your account ");
          return;
        }
    ...
    <Card className="mx-auto max-w-md">
      ...
      <CardContent>
        ...
        <div className="flex justify-center space-x-2 py-2">
            <a href="/auth/ResetPassword" className="text-blue-600 hover:underline">Forgot Password?</a> 
